...
import com.example.newfoodapp.Model.DiscountModel;
...
import com.example.newfoodapp.Model.RestaurantLocationModel;
...
import com.example.newfoodapp.ScanQRActivity;
...
public class CartFragment extends Fragment implements ILoadTimeFromFirebaseListener, ISearchCategoryCallbackListener, TextWatcher {
    ...
    @BindView(R.id.my_discount_code)
    EditText my_discount_code;
    ...
    void onApplyDiscount(){
        ...
        if (!TextUtils.isEmpty(my_discount_code.getText().toString()))
        {
            ...
            offsetRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    discountRef.child(my_discount_code.getText().toString().toLowerCase())
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.exists()){
                                        ...
                                        if (discountModel.getUntilDate() < estimatedServerTimeMs) {
                                            dialog.dismiss();
                                            listener.onLoadTimeFailed("Discount code has been expired");
                                        }
                                        else
                                        {
                                                dialog.dismiss();
                                            ...
                                            dialog.dismiss();
                                            listener.onLoadTimeFailed("Discount is not valid ");
                                ...
                                public void onSuccess(Double totalPrice) {
                                    ...
                                    if (currentLocation != null){
                                        ...
                                        if (location!=null)
                                        {
                                            ...
                                            orderLocation.setLatitude(currentLocation.getLongitude());

                                            Location restaurantLocation = new Location("");
                                            restaurantLocation.setLatitude(location.getLat());
                                            restaurantLocation.setLatitude(location.getLng());

                                            float distance = orderLocation.distanceTo(restaurantLocation)/1000;  // its in km
                                    ...
                                    order.setTotalPayment(totalPrice+order.getShippingCost());
   ...
   // ;
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==SCAN_QR_PERMISSION){
            ...
            {
                my_discount_code.setText(data.getStringExtra(Common.QR_CODE_TAG).toLowerCase());
